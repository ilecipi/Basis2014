		...
		\item Atomic opreation
 		...
 		\item Thread safety
 			...
 			\item Synchronization is not easy
 				\begin{itemize}
 					\item Concurrent acces breaks many assumptions from sequential programming. Terefore NO assumptions can be made about the relative exection speed of threads
