...
\item Categories of loops
  \begin{itemize}
    \item \textbf{Definite loop}: Executes a known number of times.
      \begin{itemize}
        \item The \textbf{for} loops we have seen are definite loops
          \begin{itemize}
     		...
     		\item \textbf{object-oriented programming (OOP)}:\\Programs that perform their behavior as interactions between objects.
     			\begin{itemize}
     				...
     				\item behavior: methods inside the object 
     					...
     					\end{itemize}
     				\item Constructing an object:\\Type objectName = new Type (parameters);
     				\item Calling an object's method:\\ objectName.methodName (parameters);
     				\todo[inline]{Formattazione in Java???}
     			\end{itemize}
     	\end{itemize}
     	\item Inheritance\\
