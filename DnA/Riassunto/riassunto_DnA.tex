...
\begin{center}
\includegraphics[scale=0.6]{singlerot.jpg}
\includegraphics[scale=0.55]{doublerot.jpg}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{avldeletion.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{splay.jpg}
\end{center}
\subsection*{Vocabolario}
\begin{itemize}
