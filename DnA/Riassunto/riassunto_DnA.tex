...
Grazie ad extendible hashing è possibile trovare l'indirizzo di una chiave ricercata con al massimo 2 accessi alla memoria esterna. Il sistema prevede di utilizzare tutti gli indirizzi disponibili. Nell'esempio precedente c'è ad esempio un solo numero che inizia con 1 ma 4 celle nella tabella degli indirizzi. Potrebbo benissimo utilizzarne solo uno. Con * vengono marcati indirizzi fittizzi, vale a dire blocchi in cui non viene salvato niente. 
\begin{center}
