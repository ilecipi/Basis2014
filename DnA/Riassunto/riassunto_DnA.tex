...
Sia G la capienza massima dello zaino, w[i] il valore dell'itesimo oggetto e g[i] il peso di esso. La formula ricorisva per la soluzione del problema è la seguente:
...
\item Conquer: ReportCuts(S1), ReportCuts(S2).
...
\item Conquer: ReportInc(S1), ReportInc(S2)
