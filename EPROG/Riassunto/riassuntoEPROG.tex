...
\item \textbf{Publisher}: Describes the properties of a typical publisher in charge of an event type. It can trigger events through \inline{publish}\todo{Not sure if it a command}, and subscribers can subscribe and unsubscribe
